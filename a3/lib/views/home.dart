                ...
                onPressed: () async {
                  if (stockSymbol.isNotEmpty) {
                    ...
                    try {
                      ...
                      var stockQuote = await stockService.getQuote(symbol);

                      companyName = companyInfo['CompanyName'];
                      price = stockQuote['Global Quote']['05. price'];

                      Stock newStock = Stock(symbol: symbol, name: companyName, price: price);

                      await databaseService.insertStock(newStock);
